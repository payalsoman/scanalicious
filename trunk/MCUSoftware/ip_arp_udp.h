...
extern void init_ip_arp_udp(uint8_t *mymac,uint8_t *myip, uint8_t *mypcip, uint8_t *mypcmac);
...
extern void send_udp_packet(uint8_t *buf,uint8_t *data, uint16_t datalen, uint16_t lineNum, uint8_t seq);
